...
let idol = [
  ...
  { id: 4, name: "有村 麻央", age: 17, size: 157, weight: 46, song: 5, period: "2024年5月16日", explanation: "過激のスターに憧れ、カッコいいアイドルを目指す3年生の女の子。初星学園アイドル科の寮の寮長をしており面倒見がよい。後輩達からは小さな王子様（リトルプリンス）として慕われている。" },
  { id: 5, name: "葛城 リーリヤ", age: 15, size: 161, weight: 43, song: 5, period: "2024年5月16日", explanation: "海外出身の新入生。歌やダンスの経験はなく、いつも自信がなさそうに縮こまっている。アイドルへの憧れは本物で、相当な努力家。親友の清夏とは、一緒にステージに立つ約束をしている。" },
  { id: 6, name: "倉本 千奈", age: 15, size: 148, weight: 43, song: 5, period: "2024年5月16日", explanation: "甘やかされて育った生粋のお嬢様。天真爛漫な女の子。「立派なアイドル」を夢見て初星学園に入学した。その実力は、本人いわく「全校生徒の中で最下位ですわ！」とのこと。" },
  { id: 7, name: "紫雲 清夏", age: 15, size: 168, weight: 54, song: 5, period: "2024年5月16日", explanation: "授業やレッスンをサボる不真面目なギャル。おちゃらけた態度ではあるが、元気で明るく、誰とでも仲良くなれる気質は彼女の魅力だ。懸命にアイドルを目指している親友のリーリヤを応援している。" },
  { id: 8, name: "篠澤 広", age: 15, size: 159, weight: 41, song: 5, period: "2024年5月16日", explanation: "ミステリアスな雰囲気漂う天才少女。簡単で退屈すぎる日々を厭い、苦手分野に挑戦すべく初星学園に入学した。「辛く苦しいレッスン」や「うまくいかないこと」に喜びを感じる変人。アイドルを目指した理由は「いちばんわたしに向いてなさそうだから」。" },
  { id: 9, name: "姫崎 莉波", age: 17, size: 166, weight: 56, song: 5, period: "2024年5月16日", explanation: "大人びた雰囲気のある3年生。しっかりもので優しく、面倒見のいい寮のみんなのお姉さん。過去にユニットに所属していたこともあるが、結果は振るわなかった。生徒会の書記を務めている。" },
  { id: 10, name: "花海 佑芽", age: 15, size: 158, weight: 50, song: 3, period: "2024年6月1日", explanation: "補欠入学の新入生。元気いっぱい、身体能力抜群の元アスリート。 姉である咲季のことが大大大大大好きで、心から尊敬し、ライバル視し、最大の目標としている。" },
  { id: 11, name: "十王 星南", age: 17, size: 170, weight: 54, song: 3, period: "2024年11月16日", explanation: "学園長の孫娘で、初星学園の生徒会長。「学園一のアイドル」と呼ばれ、多くの生徒たちから慕われている。「アイドルの才能を見抜く」特技があり、ことねを一目で気に入るが、なぜか距離を置かれてしまう。" },
  { id: 12, name: "秦谷 美鈴", age: 15, size: 160, weight: 42, song: 2, period: "2025年5月16日", explanation: "のんびりマイペースな女の子。自分にも他人にも優しく甘い。他者のお世話をしたり、甘やかしたりするのが大好き。甘えん坊な親友を、妹や娘のように慈しみ、大切にしている。" },
  { id: 13, name: "雨夜 燕", age: 17, size: 169, weight: 51, song: 1, period: "2025年11月16日", explanation: "初星学園生徒会副会長。学園No.2のアイドル。自分にも他人にも厳しいが、面倒見は良い。幼馴染の星南をライバル視しており、いずれ星南を超えて『一番星』になると公言している。" },
];
// 一覧
